...
- **Entitlements File**: `Config/LinearCalendarMobile.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/LinearCalendarMobile.entitlements`:
